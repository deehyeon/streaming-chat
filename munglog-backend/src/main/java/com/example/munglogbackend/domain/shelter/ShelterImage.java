...
public class ShelterImage extends AbstractEntity {
    ...
    private ShelterImage(Shelter shelter, String imageUrl) {
        this.shelter = shelter;
        this.imageUrl = imageUrl;
    }

    public static ShelterImage create(Shelter shelter, String imageUrl) {
        validateImageUrl(imageUrl);
        return new ShelterImage(shelter, imageUrl);
    }
