...
export default function ProtectedPostCreate({ setCurrentPage }) {
  ...
  return (
    <div className="max-w-3xl mx-auto py-8 px-4">
      ...
      <div className="text-center mb-8">
        <h1 className="text-2xl font-bold text-gray-800 mb-4">보호 게시판 게시글 작성</h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="bg-white rounded-2xl p-8 shadow-sm">
          <h2 className="text-xl font-bold text-gray-800 mb-6">보호 게시글 작성하기</h2>
          ...
          <div className="mb-6">
            ...
            <input
              ...
              onChange={handleInputChange}
              placeholder="보호중인 강아지의 나이를 입력해주세요."
              className="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:border-gray-400 text-sm"
            />
          </div>
          ...
          <div className="mb-6">
            ...
            <input
              ...
              onChange={handleInputChange}
              placeholder="보호중인 강아지의 성별을 입력해주세요."
              className="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:border-gray-400 text-sm"
            />
          </div>
