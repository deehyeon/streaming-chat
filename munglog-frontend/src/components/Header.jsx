...
export default function Header({ currentPage, setCurrentPage, isLoggedIn }) {
  return (
        ...
        <div className="flex items-center gap-8">
          ...
          <nav className="flex items-center gap-6">
            <button 
              ...
              style={{ 
                color: currentPage === 'shelters' ? colors.primary : '#1f2937'
              }}
            >
              보호소 찾기
            </button>
            <button 
              ...
              className="text-base font-semibold transition hover:text-yellow-500"
              style={{ 
                color: currentPage === 'missing' ? colors.primary : '#1f2937'
              }}
            >
              분실/보호
            </button>
            <button 
              ...
              className="text-base font-semibold transition hover:text-yellow-500"
              style={{ 
                color: currentPage === 'adoption' ? colors.primary : '#1f2937'
              }}
            >
              분양하기
            </button>
          ...
          {isLoggedIn ? (
            ...
            <>
              <button 
                ...
                className="px-4 py-2 text-sm font-semibold transition hover:text-yellow-500"
